...
import info.parsa.erp.Task0App;
import info.parsa.erp.config.Constants;
import info.parsa.erp.domain.User;
import info.parsa.erp.repository.AuthorityRepository;
import info.parsa.erp.repository.UserRepository;
import info.parsa.erp.security.AuthoritiesConstants;
import info.parsa.erp.service.UserService;
import info.parsa.erp.service.dto.PasswordChangeDTO;
import info.parsa.erp.service.dto.UserDTO;
import info.parsa.erp.web.rest.vm.KeyAndPasswordVM;
import info.parsa.erp.web.rest.vm.ManagedUserVM;
...
import static info.parsa.erp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = Task0App.class)
