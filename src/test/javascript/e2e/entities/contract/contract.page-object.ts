...
export class ContractDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('task0App.contract.delete.question'));
...
export default class ContractComponentsPage {
  ...
  async deleteContract() {
    ...
    expect(await contractDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/task0App.contract.delete.question/);
