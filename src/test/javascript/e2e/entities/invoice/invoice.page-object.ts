...
export class InvoiceDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('task0App.invoice.delete.question'));
...
export default class InvoiceComponentsPage {
  ...
  async deleteInvoice() {
    ...
    expect(await invoiceDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/task0App.invoice.delete.question/);
